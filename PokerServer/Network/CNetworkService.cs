...
namespace FreeNet
{
    public class CNetworkService
    {
		...
		public SessionHandler seesionCreatedCallback { get; set; }
		...
		public CNetworkService()
		{
			...
			this.seesionCreatedCallback = null;
		}
    ...
    //        Console.WriteLine(string.Format("[{0}] 새로운 사용자 접속 스레드. 사용자 핸들 {1},  현재 접속 사용자 {2}",
			...
			if (this.seesionCreatedCallback != null)
			{
				user_token = receive_args.UserToken as CUserToken;
				this.seesionCreatedCallback(user_token);
			}
		...
		//
		private void packetReceive(SocketAsyncEventArgs e)
		{
